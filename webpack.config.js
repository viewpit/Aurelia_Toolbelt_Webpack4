...
module.exports = ({
  ...
  module: {
    rules: [
      ...
      {
        test: /\.woff2(\?v=[0-9]\.[0-9]\.[0-9])?$/i, loader: 'url-loader', options: { limit: 10000, mimetype: 'application/font-woff2', name:'../dist/[hash].[ext]' }
      },
      {
        test: /\.woff(\?v=[0-9]\.[0-9]\.[0-9])?$/i, loader: 'url-loader', options: { limit: 10000, mimetype: 'application/font-woff', name: '../dist/[hash].[ext]' }
      },
      // load these fonts normally, as files:
      {
        test: /\.(ttf|eot|svg|otf)(\?v=[0-9]\.[0-9]\.[0-9])?$/i, loader: 'file-loader', options: { name: '../dist/[hash].[ext]' }
      },
      ...when(coverage, {
        test: /\.[jt]s$/i,
